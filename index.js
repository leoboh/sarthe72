...
/**/
/**/
const changeSvgDashBoard = () => {
    if (document.querySelector("#divSectionBoardDashBoard")) {
        document.querySelector("#svgNavDashBoard").classList.remove("svgNavDashBoardClose");
        document.querySelector("#svgNavDashBoard").classList.add("svgNavDashBoardOpen");
        ...
        document.querySelector("#svgNavDashBoard").classList.remove("svgNavDashBoardOpen");
        document.querySelector("#svgNavDashBoard").classList.add("svgNavDashBoardClose");
        document.querySelector("#svgNavDashBoard").innerHTML = `
            <path d="M96 160C96 142.3 110.3 128 128 128L512 128C529.7 128 544 142.3 544 160C544 177.7 529.7 192 512 192L128 192C110.3 192 96 177.7 96 160zM96 320C96 302.3 110.3 288 128 288L512 288C529.7 288 544 302.3 544 320C544 337.7 529.7 352 512 352L128 352C110.3 352 96 337.7 96 320zM544 480C544 497.7 529.7 512 512 512L128 512C110.3 512 96 497.7 96 480C96 462.3 110.3 448 128 448L512 448C529.7 448 544 462.3 544 480z"/>
        `;
    }
    ...
    document.querySelector("#sectionBoard").innerHTML = `
        <div id="divSectionBoardDashBoard" class="">
            <div id="divAllUnitsDashBoard">
                <div id="divUnitDelivery" class="divUnit animDivUnitDeliveryDashBoard" onclick="lunchPage()">
                ...
                <div id="divUnitActu" class="divUnit animDivUnitActuDashBoard" onclick="actuPage()">
...
const homePage = () => {
    ...
    document.querySelector("#sectionBoard").innerHTML = `
        ...
        <div id="divSectionBoardUnits" class="">
            ...
            <div id="divAllUnits">
                <div id="divUnitDelivery" class="divUnit animDivUnitDelivery" onclick="lunchPage()">
                    <div id="divUnitDeliveryh2" class="divUnith2">
                        <h2 class="h2Unit">Livraison de repas à domicile</h2>
                    </div>
                    <div id="divUnitImgDelivery" class="divUnitImg">
                ...
                <div id="divUnitActu" class="divUnit animDivUnitActu" onclick="actuPage()">
                    <div id="divUnitActuh2" class="divUnith2">
                        <h2 class="h2Unit">Actualités</h2>
                    </div>
                    <div id="divUnitActuImg" class="divUnitImg">
...
const lunchPage = () => {
    ...
    document.querySelector("#sectionBoard").innerHTML = `
        <div id="divSectionBoardLunch" class="">
            <div id="divLunchMenu" class="divUnitLunch divSectionBoard" onclick="menuPage()">
            ...
            <div id="divLunchContrat" class="divUnitLunch divSectionBoard" onclick="contratPage()">
    ...
    document.querySelector("#sectionBoard").innerHTML = `
        <div id="divSectionBoardAllActu" class="">
            <ul id="uldivSectionBoardActu">
                <li id="liActuOne" class="liUldivSectionBoardActu" onclick="actuOnePage()">
                ...
                <li id="liActuTwo" class="liUldivSectionBoardActu" onclick="actuTwoPage()">
                ...
                <li id="liActuThree" class="liUldivSectionBoardActu" onclick="actuThreePage()">
    ...
    document.querySelector("#sectionBoard").innerHTML = `
        <div id="divSectionBoardContact" class="">
            ...
            <div id="divSvgContactPage">
                <svg id="svgPhoneContactPage" class="svgContactPage" onclick="svgPhone(), animClick(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path d="M160.2 25C152.3 6.1 131.7-3.9 112.1 1.4l-5.5 1.5c-64.6 17.6-119.8 80.2-103.7 156.4 37.1 175 174.8 312.7 349.8 349.8 76.3 16.2 138.8-39.1 156.4-103.7l1.5-5.5c5.4-19.7-4.7-40.3-23.5-48.1l-97.3-40.5c-16.5-6.9-35.6-2.1-47 11.8l-38.6 47.2C233.9 335.4 177.3 277 144.8 205.3L189 169.3c13.9-11.3 18.6-30.4 11.8-47L160.2 25z"/>
                </svg>
                <svg id="svgMailContactPage" class="svgContactPage" onclick="svgMail(), animClick(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                ...
                <svg id="svgMapContactPage" class="svgContactPage" onclick="svgMap(), animClick(this)" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
...
svgMail = () => {
    ...
    document.querySelector("#divElemContact").innerHTML = `
        <form id="formDivSectionBoardContact" action="#">
            ...
            <button onclick="sendMail(), animClick(this)" class="buttonFormContact" type="button">Envoyer</button>
        </form>
    `;
    checkInput();
    checkEmail();
